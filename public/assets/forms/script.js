...
jQuery(document).ready(function() {
    ...
    $('form .btn-next').on('click', function() {
    	...
    	parent_fieldset.find('input[type="password"], input[type="username"], input[type="tel"], input[type="url"]').each(function() {
    		if( $(this).val() == "" ) {
...
/*    	parent_fieldset.find('input[type="checkbox"]').each(function() {
    ...
    $('form').on('submit', function(e) {
    	$(this).find('input[type="password"], input[type="username"]').each(function() {
    		if( $(this).val() == "" ) {
    			e.preventDefault();
    			$(this).addClass('input-error');
    		}
