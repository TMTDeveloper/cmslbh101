...
<div class="form-group {{ $errors->has('no_contact') ? 'has-error' : '' }}">
    <label for="no_contact" class="col-md-2 control-label">No Contact</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('regency_id') ? 'has-error' : '' }}">
    <label for="regency_id" class="col-md-2 control-label">Regency</label>
    <div class="col-md-10">
...
<div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="address" type="text" id="address" value="{{ old('address', optional($network)->address) }}" maxlength="255" placeholder="Ketik di sini...">
