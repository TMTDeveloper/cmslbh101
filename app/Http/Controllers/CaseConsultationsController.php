...
class CaseConsultationsController extends Controller
{
 ...
 public function store(Request $request)
 {
  ...
  try {
   ...
   return back()->withInput()
    ->withErrors(['unexpected_error' => $data]);
  }
 }
 ...
 protected function getData(Request $request)
 {
  $rules = [
   ...
   'case_position'  => 'required|string|min:-2147483648|max:2147483647',
   'case_analysis'  => 'required|string|min:-2147483648|max:2147483647',
   'case_note'      => 'required|string|min:-2147483648|max:2147483647',
